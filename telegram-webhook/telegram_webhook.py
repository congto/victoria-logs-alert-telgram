...
def alert():
    ...
    for alert in data.get("alerts", []):
        ...
        msg += f"<b>Severity:</b> {alert['labels'].get('severity', 'N/A')}\n"
        msg += f"<b>Summary:</b> {alert['annotations'].get('summary', '')}\n"
        msg += f"<b>Description:</b> {alert['annotations'].get('description', '')}"
